...
func NewEBIBlastRepository(url string) *EBIBlastRepository {
	return &EBIBlastRepository{url: url}
}

func (blast *EBIBlastRepository) Search(sequence string) (string, error) {
	client := resty.New()
